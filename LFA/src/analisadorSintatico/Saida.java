...
import static analisadorSintatico.TesteAnalisadorSintatico.parser;
...
public class Saida extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            parser = new MyAnalisadorSintatico(jTextArea1.getText());
            parser.programa();
            jTextArea2.setText("Análise realizada com sucesso no arquivo \n" + parser.nomeArquivoEntrada);
        } catch(ErroLexico e) {
            jTextArea2.setText("Erro léxico: \n" + e.toString());
        } catch(ErroSintatico e) {
            jTextArea2.setText("Erro sintático: \n" + e.toString());
        } catch(RuntimeException e) {
            jTextArea2.setText("Erro: \n" + e.getMessage());
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            jTextArea1.setText("Erro: " + e.toString());
        }
